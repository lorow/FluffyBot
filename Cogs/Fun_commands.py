...
class Fun_commands(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self.reactions = {"crusade": "https://www.youtube.com/watch?v=Ky2UP5j_pK8"}
    ...
    async def crusade(self, ctx):
        ...
        await ctx.send(
            random_quotes[random.randint(0, len(random_quotes))]
            + "\n"
    ...
    async def decide(self, ctx, *, args: str):
        ...
        try:
            ...
            await ctx.send(
                "Something went wrong. Here's how to use this command: \n [prefix]decide first or second"
            )
